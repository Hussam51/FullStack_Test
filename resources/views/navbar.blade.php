<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container">
        <img src="https://alkhumra.com/wp-content/uploads/2022/09/lo-118x137.png" class="custom-logo" alt="Alkhumra"
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item"><a class="nav-link" href="#!">Alkhumra</a></li>
                <li class="nav-item"><a class="nav-link" href="#!">Alkhumra Lite</a></li>
                <li class="nav-item"><a class="nav-link" href="#!">Vending Machine</a></li>
                <li class="nav-item"><a class="nav-link" href="{{route('shop')}}">Shop</a></li>
                <li class="nav-item"><a class="nav-link" href="#contact">Contact Us <svg
                ...
                <li class="nav-item"><a class="nav-link active" aria-current="page" href="#" width="20px"> <svg
